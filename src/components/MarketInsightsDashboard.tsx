      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12 animate-fade-in">
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-bh-navy mb-4 hover:text-bh-coral transition-colors duration-300 cursor-default">
            Dubai Market Insights Dashboard
          </h2>
        ...
        <Tabs defaultValue="roi-calculator" className="w-full">
          ...
          <TabsContent value="market-analytics" className="space-y-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              <Card className="hover:shadow-lg transition-all duration-300">
                <CardHeader>
                  <CardTitle>Dubai Offplan Price Trends (Avg. AED/sqft)</CardTitle>
                </CardHeader>
                <CardContent>
                  <div className="h-80">
                    <Chart
              ...
              <Card className="hover:shadow-lg transition-all duration-300">
                <CardHeader>
                  <CardTitle>Potential Offplan Rental Yields by Type</CardTitle>
                </CardHeader>
                <CardContent>
                  <div className="h-80">
                    <Chart
              ...
              <Card className="hover:shadow-lg transition-all duration-300">
                <CardHeader>
                  <CardTitle>Dubai Offplan Supply vs Demand</CardTitle>
                </CardHeader>
                <CardContent>
                  <div className="h-80">
                    <Chart
              ...
              <Card className="hover:shadow-lg transition-all duration-300">
                <CardHeader>
                  <CardTitle>Sobha Realty Performance Metrics (%)</CardTitle>
                </CardHeader>
                <CardContent>
                  <div className="h-80">
                    <Chart
                ...
                <CardContent>
                  <div className="grid grid-cols-2 gap-6">
                    <Card className="bg-gray-50 hover:shadow-md transition-all duration-300 transform hover:scale-[1.02]">
                      ...
                      <CardContent>
                        <div className="text-4xl font-bold text-bh-coral">{roi.yearlyROI}%</div>
                    ...
                    <Card className="bg-gray-50 hover:shadow-md transition-all duration-300 transform hover:scale-[1.02]">
                      ...
                      <CardContent>
                        <div className="text-4xl font-bold text-bh-coral">AED {roi.monthlyRental}</div>
                    ...
                    <Card className="bg-gray-50 hover:shadow-md transition-all duration-300 transform hover:scale-[1.02]">
                      ...
                      <CardContent>
                        <div className="text-4xl font-bold text-bh-coral">AED {parseInt(roi.fiveYearValue).toLocaleString()}</div>
                    ...
                    <Card className="bg-gray-50 hover:shadow-md transition-all duration-300 transform hover:scale-[1.02]">
                      ...
                      <CardContent>
                        <div className="text-4xl font-bold text-bh-coral">AED {parseInt(roi.totalAppreciation).toLocaleString()}</div>
          ...
          <TabsContent value="tax-legal">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              <Card className="hover:shadow-lg transition-all duration-300">
                <CardHeader>
                  <CardTitle>Tax Benefits for Foreign Investors</CardTitle>
                </CardHeader>
                <CardContent>
              ...
              <Card className="hover:shadow-lg transition-all duration-300">
                <CardHeader>
                  <CardTitle>Legal Protections for Off-Plan Investors</CardTitle>
                </CardHeader>
                <CardContent>
                  <ul className="space-y-4">
                    <li className="flex items-start">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <Button variant="outline" className="text-bh-coral border-bh-coral hover:bg-bh-coral hover:text-white" onClick={handleRegisterClick}>
                            ...
                            {isAuthenticated ? 'Download' : 'Register'}
                          </Button>
                        </div>
                      </div>
                    </div>
