    ...
    <section className="py-16 bg-white">
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-4xl mx-auto">
          <Card className="bg-gradient-to-br from-white to-gray-50 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-[1.02]">
            <CardContent className="p-8">
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-center">
                ...
                <div className="lg:col-span-2 text-center lg:text-left animate-[fade-in_1.2s_ease-out]">
                  <h3 className="text-2xl md:text-3xl font-bold text-bh-navy mb-2 hover:text-bh-coral transition-colors duration-300">
                    Chirine Elsebai
                  </h3>
              ...
              <div className="mt-8 pt-8 border-t border-gray-200">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 animate-[fade-in_1.6s_ease-out]">
                  <div className="text-center p-4 bg-white rounded-lg hover:shadow-md transition-all duration-300 transform hover:scale-105">
