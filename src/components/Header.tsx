                ...
                <div className="absolute bottom-8 left-6 right-6">
                  {isAuthenticated ? (
                    ...
                    <div className="flex flex-col space-y-3">
                       <Button className="w-full bg-bh-coral hover:bg-bh-coral/90 text-white" onClick={() => handleAuthNav('/register')}>
                        Register
                      </Button>
                      <Button variant="outline" className="w-full border-bh-navy text-bh-navy" onClick={() => handleAuthNav('/login')}>
                        Login
                      </Button>
                    </div>
                  )}
