        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          <Card className="text-center">
            <CardContent className="p-6">
              ...
              <p className="text-gray-600">June 28th, 2025</p>
          ...
          <Card className="text-center">
            <CardContent className="p-6">
              ...
              <p className="text-gray-600">Hilton Amsterdam</p>
              <p className="text-gray-600">Apollolaan 138, 1077 BG Amsterdam, Netherlands</p>
            </CardContent>
          </Card>
          ...
          <Card className="text-center">
            <CardContent className="p-6">
              ...
              <p className="text-gray-600">Free entry with registration</p>
